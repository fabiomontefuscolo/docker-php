...
```
docker run --name tikiwiki -v /path/tiki-source:/var/www/html -d tikiwiki/php:7-fpm
```
...
```
docker run --name tikiwiki -e XDEBUG=1 -v /path/tiki-source:/var/www/html -d tikiwiki/php:7-fpm
```
